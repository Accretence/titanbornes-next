                ...
                <div className="PageContent">
                    ...
                    <Card className="WikiContent">
                        ...
                        <Text small>
                            ...
                            We are running a subgraph to fetch and index
                            on-chain transactions. Each time a FUSION happens
                            our smart-contract broadcasts it as an event for our
                            subgraph to fetch. All of this happens so that we
                            can always query the latest version of your NFT's
                            ON-CHAIN attributes.
                            <br />
                            <Text span b>
                                2nd.
                            </Text>{' '}
                            We have built an API from scratch to assemble and
