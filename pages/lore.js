				...
				<div className="PageContent">
					...
					<Card mb={1} className="WikiContent">
						...
						<Text small>
							...
							immediately knew what abominations they had created
							and vowed to never birth children out of their own
							flesh. They knew they had to contain the evil and
							imprisoned the Nightmares. They poured their own
							...
							only possible being capable of taking on the
							Nightmares if they ever escaped their captivity.
						</Text>
					</Card>
					<Card mb={1} className="WikiContent">
						...
						<Text small>
							...
							>
								Reapers
							</Badge> are more powerful and adept to battle.
							<br/>
							<Badge
								style={{
									backgroundColor: 'purple',
							...
							>
								Tricksters
							</Badge> are the smartest and more shrewd.
						</Text>
					</Card>
					<Card mb={1} className="WikiContent">
						...
						<Text small>
							...
							They tell the story of creation to Z, how the Titans
							created the world and how they birthed their first
							childs, Nightmares from their own bodies and
							...
							>
								Titanbornes
							</Badge> to destroy their own
							first childs if they ever escaped their captivity.
							Nightmares created an amulet just before they were
							imprisoned, an amulet that holds the power to
							manipulate Ichor, blood of the Titans that flows
							inside Titanbornes. Z finds the amulet with their
							directions.
						</Text>
					</Card>
					<Card className="WikiContent">
						...
						<Text small>
							...
							>
								Titanbornes
							</Badge> believe themeselves to
							be gentle and just creatures wrongfully robbed of
							living for thousands of years. They decide to find
							their way out of the Crypt and to the outside world.
							They find hordes of sentries guarding their way to
							the gate but they start moving, gathering resources
							and fighting their way to the gate. Can they open
							the gate? What is waiting on the other side?
						</Text>
					</Card>
				</div>
			</div>
