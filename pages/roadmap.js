            ...
            <div className="PageWrapper">
                <div className="PageContent">
                    <Card mb={1} className="WikiContent">
                        ...
                        <Text small>
                            • Fair-launch of Titanborne NFTs. A TRUE COMMUNITY
                            will shape itself around a tangibly refreshing idea
                            that fairly distributes value to those who genuinely
                            want to be a part of it.
                        </Text>
                        <br />
                        <Text small>
                            • Our 1st. experiment begins. How many{' '}
                            <Badged c="TITANBORNES" /> will survive? What will
                            the highest fusion count be? What can we possibly
                            have in mind for your NFT's fusion count in the next
                            chapters?
                        </Text>
                    </Card>
                    <Card mb={1} className="WikiContent">
